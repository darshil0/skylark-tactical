...
## [1.8.1] - 2026-05-09 — Documentation & Workflow Formalization

### Added
- **Contributing Guide**: Implemented `CONTRIBUTING.md` to formalize the development workflow and community contribution standards.
